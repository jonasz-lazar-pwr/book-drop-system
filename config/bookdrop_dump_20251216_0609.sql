...
--
-- Name: public; Type: SCHEMA; Schema: -; Owner: bookdrop
--

-- *not* creating schema, since initdb creates it


ALTER SCHEMA public OWNER TO bookdrop;

--
-- Name: SCHEMA public; Type: COMMENT; Schema: -; Owner: bookdrop
--
...
--
-- Name: tiger; Type: SCHEMA; Schema: -; Owner: bookdrop
--

CREATE SCHEMA tiger;


ALTER SCHEMA tiger OWNER TO bookdrop;

--
-- Name: tiger_data; Type: SCHEMA; Schema: -; Owner: bookdrop
--

CREATE SCHEMA tiger_data;


ALTER SCHEMA tiger_data OWNER TO bookdrop;

--
-- Name: topology; Type: SCHEMA; Schema: -; Owner: bookdrop
--

CREATE SCHEMA topology;


ALTER SCHEMA topology OWNER TO bookdrop;

--
-- Name: SCHEMA topology; Type: COMMENT; Schema: -; Owner: bookdrop
--
...
--
-- Name: book_location; Type: TYPE; Schema: public; Owner: bookdrop
--
...
ALTER TYPE public.book_location OWNER TO bookdrop;

--
-- Name: TYPE book_location; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart_status; Type: TYPE; Schema: public; Owner: bookdrop
--
...
ALTER TYPE public.cart_status OWNER TO bookdrop;

--
-- Name: TYPE cart_status; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_status; Type: TYPE; Schema: public; Owner: bookdrop
--
...
ALTER TYPE public.order_status OWNER TO bookdrop;

--
-- Name: TYPE order_status; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: shipment_mode; Type: TYPE; Schema: public; Owner: bookdrop
--
...
ALTER TYPE public.shipment_mode OWNER TO bookdrop;

--
-- Name: TYPE shipment_mode; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: shipment_status; Type: TYPE; Schema: public; Owner: bookdrop
--
...
ALTER TYPE public.shipment_status OWNER TO bookdrop;

--
-- Name: TYPE shipment_status; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: user_role; Type: TYPE; Schema: public; Owner: bookdrop
--
...
ALTER TYPE public.user_role OWNER TO bookdrop;

--
-- Name: TYPE user_role; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: auto_close_old_carts(); Type: FUNCTION; Schema: public; Owner: bookdrop
--
...
ALTER FUNCTION public.auto_close_old_carts() OWNER TO bookdrop;

--
-- Name: enforce_lowercase_email(); Type: FUNCTION; Schema: public; Owner: bookdrop
--
...
ALTER FUNCTION public.enforce_lowercase_email() OWNER TO bookdrop;

--
-- Name: generate_pickup_code(); Type: FUNCTION; Schema: public; Owner: bookdrop
--
...
ALTER FUNCTION public.generate_pickup_code() OWNER TO bookdrop;

--
-- Name: sync_book_item_availability(); Type: FUNCTION; Schema: public; Owner: bookdrop
--
...
ALTER FUNCTION public.sync_book_item_availability() OWNER TO bookdrop;

--
-- Name: update_cart_timestamp(); Type: FUNCTION; Schema: public; Owner: bookdrop
--
...
ALTER FUNCTION public.update_cart_timestamp() OWNER TO bookdrop;

--
-- Name: update_order_timestamp(); Type: FUNCTION; Schema: public; Owner: bookdrop
--
...
ALTER FUNCTION public.update_order_timestamp() OWNER TO bookdrop;
...
--
-- Name: book; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.book OWNER TO bookdrop;

--
-- Name: TABLE book; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: COLUMN book.source; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: book_item; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.book_item OWNER TO bookdrop;

--
-- Name: TABLE book_item; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.cart OWNER TO bookdrop;

--
-- Name: TABLE cart; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: COLUMN cart.user_id; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart_item; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.cart_item OWNER TO bookdrop;

--
-- Name: TABLE cart_item; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.locker OWNER TO bookdrop;

--
-- Name: TABLE locker; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_box; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.locker_box OWNER TO bookdrop;

--
-- Name: TABLE locker_box; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_shipment; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.locker_shipment OWNER TO bookdrop;

--
-- Name: TABLE locker_shipment; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public."order" OWNER TO bookdrop;

--
-- Name: TABLE "order"; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_item; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public.order_item OWNER TO bookdrop;

--
-- Name: TABLE order_item; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_requested_item; Type: TABLE; Schema: public; Owner: bookdrop
--

CREATE TABLE public.order_requested_item (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    order_id uuid NOT NULL,
    isbn text NOT NULL,
    quantity integer NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT order_requested_item_quantity_check CHECK ((quantity > 0))
);


ALTER TABLE public.order_requested_item OWNER TO bookdrop;

--
-- Name: TABLE order_requested_item; Type: COMMENT; Schema: public; Owner: bookdrop
--

COMMENT ON TABLE public.order_requested_item IS 'Logical snapshot of items requested in an order (ISBN + quantity). Used by librarian to assign physical book copies.';


--
-- Name: user; Type: TABLE; Schema: public; Owner: bookdrop
--
...
ALTER TABLE public."user" OWNER TO bookdrop;

--
-- Name: TABLE "user"; Type: COMMENT; Schema: public; Owner: bookdrop
--
...
--
-- Data for Name: book; Type: TABLE DATA; Schema: public; Owner: bookdrop
--
...
--
-- Data for Name: book_item; Type: TABLE DATA; Schema: public; Owner: bookdrop
--
...
--
-- Data for Name: cart; Type: TABLE DATA; Schema: public; Owner: bookdrop
--

COPY public.cart (id, user_id, status, created_at, updated_at) FROM stdin;
dee1253b-ee7e-4742-aec2-be86ae828bf0	0f5e2ecc-3bad-4371-9129-083f831e15c0	submitted	2025-12-16 05:04:58.413951+00	2025-12-16 05:05:18.347132+00
3e47282c-c690-4caa-987d-7dc5001614e5	0f5e2ecc-3bad-4371-9129-083f831e15c0	active	2025-12-16 05:05:18.347132+00	2025-12-16 05:05:18.347132+00
\.


--
-- Data for Name: cart_item; Type: TABLE DATA; Schema: public; Owner: bookdrop
--

COPY public.cart_item (id, cart_id, isbn, quantity, added_at) FROM stdin;
04502831-3729-441c-b123-70c9211d97ca	dee1253b-ee7e-4742-aec2-be86ae828bf0	9788324086689	2	2025-12-16 05:04:58.413951+00
\.


--
-- Data for Name: locker; Type: TABLE DATA; Schema: public; Owner: bookdrop
--
...
--
-- Data for Name: locker_box; Type: TABLE DATA; Schema: public; Owner: bookdrop
--
...
6d1ca453-6135-4705-a85b-9a3b5276da1a	03d09d1b-c39b-4ab1-8a9b-4d7a50448681	1	f
\.


--
-- Data for Name: locker_shipment; Type: TABLE DATA; Schema: public; Owner: bookdrop
--

COPY public.locker_shipment (id, order_id, locker_box_id, mode, status, pickup_code, placed_at, created_at) FROM stdin;
8bfd66e0-82c4-4211-92aa-03c4e3b55e37	7966143b-3fd1-4707-9cd2-673f788234cb	6d1ca453-6135-4705-a85b-9a3b5276da1a	delivery	created	95e48c42	\N	2025-12-16 05:05:18.347132+00
\.


--
-- Data for Name: order; Type: TABLE DATA; Schema: public; Owner: bookdrop
--

COPY public."order" (id, reader_id, status, created_at, updated_at) FROM stdin;
7966143b-3fd1-4707-9cd2-673f788234cb	0f5e2ecc-3bad-4371-9129-083f831e15c0	new	2025-12-16 05:05:18.347132+00	\N
\.


--
-- Data for Name: order_item; Type: TABLE DATA; Schema: public; Owner: bookdrop
--
...
--
-- Data for Name: order_requested_item; Type: TABLE DATA; Schema: public; Owner: bookdrop
--

COPY public.order_requested_item (id, order_id, isbn, quantity, created_at) FROM stdin;
8c1e755d-b0d6-4db3-a09e-2f1145eaead5	7966143b-3fd1-4707-9cd2-673f788234cb	9788324086689	2	2025-12-16 05:05:18.347132+00
\.


--
-- Data for Name: spatial_ref_sys; Type: TABLE DATA; Schema: public; Owner: bookdrop
--
...
--
-- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: bookdrop
--
...
--
-- Data for Name: geocode_settings; Type: TABLE DATA; Schema: tiger; Owner: bookdrop
--
...
--
-- Data for Name: pagc_gaz; Type: TABLE DATA; Schema: tiger; Owner: bookdrop
--
...
--
-- Data for Name: pagc_lex; Type: TABLE DATA; Schema: tiger; Owner: bookdrop
--
...
--
-- Data for Name: pagc_rules; Type: TABLE DATA; Schema: tiger; Owner: bookdrop
--
...
--
-- Data for Name: topology; Type: TABLE DATA; Schema: topology; Owner: bookdrop
--
...
--
-- Data for Name: layer; Type: TABLE DATA; Schema: topology; Owner: bookdrop
--
...
--
-- Name: topology_id_seq; Type: SEQUENCE SET; Schema: topology; Owner: bookdrop
--
...
--
-- Name: book_item book_item_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: book book_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart_item cart_item_cart_id_isbn_key; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart_item cart_item_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart cart_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_box locker_box_locker_id_number_key; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_box locker_box_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker locker_locker_code_key; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker locker_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_shipment locker_shipment_pickup_code_key; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_shipment locker_shipment_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_item order_item_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order order_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_requested_item order_requested_item_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--

ALTER TABLE ONLY public.order_requested_item
    ADD CONSTRAINT order_requested_item_pkey PRIMARY KEY (id);


--
-- Name: order_item uq_book_item_once; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: user user_pkey; Type: CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_book_authors; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_book_item_availability; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_book_item_isbn; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_book_item_location; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_book_title; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_cart_item_cart_id; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_cart_user_id; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_locker_box_available; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_locker_city; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_locker_location; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_order_item_book_item; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_order_item_order; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_order_reader; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_order_requested_isbn; Type: INDEX; Schema: public; Owner: bookdrop
--

CREATE INDEX idx_order_requested_isbn ON public.order_requested_item USING btree (isbn);


--
-- Name: idx_order_requested_order; Type: INDEX; Schema: public; Owner: bookdrop
--

CREATE INDEX idx_order_requested_order ON public.order_requested_item USING btree (order_id);


--
-- Name: idx_order_status; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_shipment_mode; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_shipment_order; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_shipment_status; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: idx_user_role; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: uq_user_email_lower; Type: INDEX; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart trg_cart_updated; Type: TRIGGER; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_shipment trg_locker_shipment_pickup_code; Type: TRIGGER; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_item trg_order_item_sync; Type: TRIGGER; Schema: public; Owner: bookdrop
--
...
--
-- Name: order trg_order_updated; Type: TRIGGER; Schema: public; Owner: bookdrop
--
...
--
-- Name: user trg_user_lower_email; Type: TRIGGER; Schema: public; Owner: bookdrop
--
...
--
-- Name: book_item book_item_isbn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart_item cart_item_cart_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart_item cart_item_isbn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: cart cart_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_box locker_box_locker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_shipment locker_shipment_locker_box_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: locker_shipment locker_shipment_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_item order_item_book_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_item order_item_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order order_reader_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--
...
--
-- Name: order_requested_item order_requested_item_isbn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--

ALTER TABLE ONLY public.order_requested_item
    ADD CONSTRAINT order_requested_item_isbn_fkey FOREIGN KEY (isbn) REFERENCES public.book(isbn);


--
-- Name: order_requested_item order_requested_item_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bookdrop
--

ALTER TABLE ONLY public.order_requested_item
    ADD CONSTRAINT order_requested_item_order_id_fkey FOREIGN KEY (order_id) REFERENCES public."order"(id) ON DELETE CASCADE;


--
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: bookdrop
--
